...
function Todo({ todo, onEditTodo, onDeleteTodo }) {
  ...
  const handleDeleteTodo = () => onDeleteTodo(todo);
      ...
      {editState ? (
        ...
        <div className={todoStyle.todo} onClick={handleClick}>
          ...
          <div className={commonTodoStyle.buttons_container}>
            <button className={commonTodoStyle.button_pink} onClick={handleEditTodo}>
              Edit Todo
            </button>
            <button className={commonTodoStyle.button_delete} onClick={handleDeleteTodo}>
              Delete Todo
            </button>
            <button className={commonTodoStyle.button_complete} onClick={handleCompleteTodo}>
              Complete Todo
            </button>
          </div>
        </div>
